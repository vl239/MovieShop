...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220619012029_CreatingRemainingTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.CastMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.CrewMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.MovieCastMember", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MovieCastMember", (string)null);
                });

            modelBuilder.Entity("ApplicationCore.Entities.MovieCrewMember", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MovieCrewMember", (string)null);
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("TwoFactorEnables")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.MovieCastMember", b =>
                {
                    b.HasOne("ApplicationCore.Entities.CastMember", "CastMember")
                        .WithMany("MoviesOfCastMember")
            ...
            modelBuilder.Entity("ApplicationCore.Entities.MovieCrewMember", b =>
                {
                    b.HasOne("ApplicationCore.Entities.CrewMember", "CrewMember")
                        .WithMany("MoviesOfCrewMember")
                        .HasForeignKey("CrewMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationCore.Entities.Movie", "Movie")
                        .WithMany("MovieCrewMembers")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ApplicationCore.Entities.CastMember", b =>
                {
                    b.Navigation("MoviesOfCastMember");
                });

            modelBuilder.Entity("ApplicationCore.Entities.CrewMember", b =>
                {
                    b.Navigation("MoviesOfCrewMember");
                });
